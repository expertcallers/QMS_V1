...
class ChatMonitoringSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['audit_date', 'associate_name', 'process', "overall_score", 'qa', 'team_lead', 'fatal',
                  'disput_status', 'status']
...
class EmbassyLuxuryInboundMonFormSerializer(serializers.ModelSerializer):
    class Meta:
...
class AmerisaveMonFormSerializer(serializers.ModelSerializer):
    class Meta:
